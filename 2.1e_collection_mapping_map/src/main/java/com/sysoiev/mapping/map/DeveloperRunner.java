...
public class DeveloperRunner {
    ...
    public static void main(String[] args) {
        ...
        projects1.put("Computer Science", new Project(1, "Proselyte Tutorial", "proselyte.net"));
        projects1.put("Aviation", new Project(2, "SkybleLib", "SkybleSoft"));

        HashMap<String, Project> projects2 = new HashMap<String, Project>();
        projects2.put("Some Sphere", new Project(3, "Some Project", "Some Company"));
        projects2.put("E-commerce", new Project(4, "One more Project", "One more Company"));
